...
type options struct {
	...
	NumOutputs   int     `long:"num-outputs" short:"n" description:"How many documents to generate . If greate than 1, the output filename must be given. It is treated as a template for filenames in which {{$}} will be replaced with the number of the file, starting with 0."`
